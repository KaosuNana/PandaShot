...
public class BossShip : MonoBehaviour {
	...
	void Start () 
	{
		...
		{
			if(LevelGenerator.currentStage > 9)
				bottomGunHealth += factorX * PandaPlane.mainGunLvl + (int)(factorY*LevelGenerator.currentStage/9f);
			else
				bottomGunHealth += factorX * PandaPlane.mainGunLvl + factorY;//*PandaPlane.mainGunLvl;
		}
		if(turretBottomHealth != 0)
		{
			if(LevelGenerator.currentStage > 9)
				turretBottomHealth += factorX * PandaPlane.mainGunLvl + (int)(factorY*LevelGenerator.currentStage/9f);
			else
				turretBottomHealth += factorX * PandaPlane.mainGunLvl + factorY;//*PandaPlane.mainGunLvl;
		}
		if(turretMiddleHealth != 0)
		{
			if(LevelGenerator.currentStage > 9)
				turretMiddleHealth += factorX * PandaPlane.mainGunLvl + (int)(factorY*LevelGenerator.currentStage/9f);
			else
				turretMiddleHealth += factorX * PandaPlane.mainGunLvl + factorY;//*PandaPlane.mainGunLvl;
		}
		if(turretTopHealth != 0)
		{
			if(LevelGenerator.currentStage > 9)
				turretTopHealth += factorX * PandaPlane.mainGunLvl + (int)(factorY*LevelGenerator.currentStage/9f);
			else
				turretTopHealth += factorX * PandaPlane.mainGunLvl + factorY;//*PandaPlane.mainGunLvl;
		}
		if(middleLaserGunHealth != 0)
		{
			if(LevelGenerator.currentStage > 9)
				middleLaserGunHealth += factorX * PandaPlane.mainGunLvl + (int)(factorY*LevelGenerator.currentStage/9f);
			else
				middleLaserGunHealth += factorX * PandaPlane.mainGunLvl + factorY;//*PandaPlane.mainGunLvl;
		}
		if(mainGunHealth != 0)
		{
			if(LevelGenerator.currentStage > 9)
	...
	public void DestroyBoss()
	{
		...
		StartCoroutine(PandaPlane.Instance.MoveCameraSlowly(4.5f));
