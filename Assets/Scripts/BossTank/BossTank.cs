...
public class BossTank : MonoBehaviour {
	...
	void Start () 
	{
		...
		{
			if(LevelGenerator.currentStage > 9)
				cannonHealth += factorX * PandaPlane.mainGunLvl + (int)(factorY*LevelGenerator.currentStage/9f);
			else
				cannonHealth += factorX * PandaPlane.mainGunLvl + factorY;//*PandaPlane.mainGunLvl;
		}
		...
		{
			if(LevelGenerator.currentStage > 9)
				laserGunHealth += factorX * PandaPlane.mainGunLvl + (int)(factorY*LevelGenerator.currentStage/9f);
			else
				laserGunHealth += factorX * PandaPlane.mainGunLvl + factorY;//*PandaPlane.mainGunLvl;
		}
		if(mainGunHealth != 0)
		{
			if(LevelGenerator.currentStage > 9)
