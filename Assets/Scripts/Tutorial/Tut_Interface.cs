...
public class Tut_Interface : MonoBehaviour {
	
	Transform slowTimeScreen;
	[HideInInspector] public bool normalTime;
	static Tut_Interface instance;
	...
	public static Tut_Interface Instance
	{
		get
		{
			if(instance == null)
			{
				instance = GameObject.FindObjectOfType(typeof(Tut_Interface)) as Tut_Interface;
			}
			return instance;
		}
	}
	...
	void StartPlaying()
	{
		Tut_PlaneManager.Instance.StartPlaying();
	}
	...
	public void PauseGame()
	{
		...
		else
		{
			...
			if(Tut_PlaneManager.controlType == 1)
			{
