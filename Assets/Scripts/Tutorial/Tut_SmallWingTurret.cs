...
public class Tut_SmallWingTurret : MonoBehaviour {
	...
	void TargetAndFire()
	{
		...
		Vector3 targetPos = Tut_PlaneManager.Instance.transform.position;
	...
	void FireBullet()
	{
		...
		Tut_SmallWingTurretBullet tempScript = bullllet.GetComponent<Tut_SmallWingTurretBullet>();
		...
		if(tempScript.available)
		{
			...
			tempScript.direction = turretGun.position - Tut_PlaneManager.Instance.transform.position;
