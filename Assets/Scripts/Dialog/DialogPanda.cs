...
//	string pandaDialogStage10 = "Ironpaw: I didn't come so far to be defeated! Let's dance Wizmaz!";
	...
	public static bool pandaCanSpeak = true;
	public static bool noTutorial = true;
	...
	void Start () {
		...
		{
		case 1:
			message = pandaDialogStage1[DialogBoss.versionDialog];
			break;
		case 2:
			message = pandaDialogStage2[DialogBoss.versionDialog];
			break;
		case 3:
			message = pandaDialogStage3[DialogBoss.versionDialog];
			break;
		case 4:
			message = pandaDialogStage4[DialogBoss.versionDialog];
			break;
		case 5:
			message = pandaDialogStage5[DialogBoss.versionDialog];
			break;
		case 6:
