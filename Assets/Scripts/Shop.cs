...
{
    public Button exitExplanation;
    public Button upgradeBtn;
    public GameObject shopscroller;
    public Text starsNumberTextShop, healthPriceText, armorPriceText, mainGunPriceText, wingGunPriceText, sideGunPriceText, magnetPriceText, shieldPriceText, doubleStarsPriceText, bombPriceText, teslaPriceText, laserPriceText, bladesPriceText;
    string[] upgradesStatesInfo = new string[12];
    public Text UpgradeTitleText, UpgradeInfoPriceText, UpgradeDescriptionText;
    ...
    void Update()
    {
        upgradeBtn.transform.GetChild(1).gameObject.SetActive(EventSystem.current.currentSelectedGameObject == upgradeBtn.gameObject);
    }
    ...
    public void UpgradeHealth()
    {
        if (currentStateHealth < 10 && stars >= healthPrice[currentStateHealth])
        {
            ...
            if (currentStateHealth == 10)
            {
                ...
                EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[0].gameObject);
            }
            else
            {
                healthPriceText.text = healthPrice[currentStateHealth].ToString();
        ...
        if (currentStateArmor < 10 && stars >= armorPrice[currentStateArmor])
        {
            ...
            else
            {
                ...
                if (currentStateArmor == 10)
                {
                    ...
                    GameObject.Find("UpgradeArmorButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[1].gameObject);
                }
                else
                {
                    armorPriceText.text = armorPrice[currentStateArmor].ToString();
        ...
        if (currentStateMainGun < 10 && stars >= mainGunPrice[currentStateMainGun])
        {
            ...
            else
            {
                ...
                if (currentStateMainGun == 10)
                {
                    ...
                    GameObject.Find("UpgradeMainGunButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[2].gameObject);
                }
                else
                {
                    mainGunPriceText.text = mainGunPrice[currentStateMainGun].ToString();
        ...
        if (currentStateWingGun < 10 && stars >= wingGunPrice[currentStateWingGun])
        {
            ...
            else
            {
                ...
                if (currentStateWingGun == 10)
                {
                    ...
                    GameObject.Find("UpgradeWingGunButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[3].gameObject);
                }
                else
                {
                    wingGunPriceText.text = wingGunPrice[currentStateWingGun].ToString();
        ...
        if (currentStateSideGun < 10 && stars >= sideGunPrice[currentStateSideGun])
        {
            ...
            else
            {
                ...
                if (currentStateSideGun == 10)
                {
                    ...
                    GameObject.Find("UpgradeSideGunButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[4].gameObject);
                }
                else
                {
                    sideGunPriceText.text = sideGunPrice[currentStateSideGun].ToString();
        ...
        if (currentStateMagnet < 10 && stars >= magnetPrice[currentStateMagnet])
        {
            ...
            else
            {
                ...
                if (currentStateMagnet == 10)
                {
                    ...
                    GameObject.Find("UpgradeMagnetButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[5].gameObject);
                }
                else
                {
                    magnetPriceText.text = magnetPrice[currentStateMagnet].ToString();
        ...
        if (currentStateShield < 10 && stars >= shieldPrice[currentStateShield])
        {
            ...
            else
            {
                ...
                if (currentStateShield == 10)
                {
                    ...
                    GameObject.Find("UpgradeShieldButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[6].gameObject);
                }
                else
                {
                    shieldPriceText.text = shieldPrice[currentStateShield].ToString();
        ...
        if (currentStateDoubleStars < 10 && stars >= doubleStarsPrice[currentStateDoubleStars])
        {
            ...
            else
            {
                ...
                if (currentStateDoubleStars == 10)
                {
                    ...
                    GameObject.Find("UpgradeDoubleStarsButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[7].gameObject);
                }
                else
                {
                    doubleStarsPriceText.text = doubleStarsPrice[currentStateDoubleStars].ToString();
        ...
        if (currentStateBomb < 10 && stars >= bombPrice[currentStateBomb])
        {
            ...
            else
            {
                ...
                if (currentStateBomb == 10)
                {
                    ...
                    GameObject.Find("UpgradeBombButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[8].gameObject);
                }
                else
                {
                    bombPriceText.text = bombPrice[currentStateBomb].ToString();
        ...
        if (currentStateTesla < 10 && stars >= teslaPrice[currentStateTesla])
        {
            ...
            else
            {
                ...
                if (currentStateTesla == 10)
                {
                    ...
                    GameObject.Find("UpgradeTeslaButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[9].gameObject);
                }
                else
                {
                    teslaPriceText.text = teslaPrice[currentStateTesla].ToString();
        ...
        if (currentStateLaser < 10 && stars >= laserPrice[currentStateLaser])
        {
            ...
            else
            {
                ...
                if (currentStateLaser == 10)
                {
                    ...
                    GameObject.Find("UpgradeLaserButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[10].gameObject);
                }
                else
                {
                    laserPriceText.text = laserPrice[currentStateLaser].ToString();
        ...
        if (currentStateBlades < 10 && stars >= bladesPrice[currentStateBlades])
        {
            ...
            else
            {
                ...
                if (currentStateBlades == 10)
                {
                    ...
                    GameObject.Find("UpgradeBladesButton").GetComponent<Button>().interactable = false;
                    EventSystem.current.SetSelectedGameObject(null);
                    EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[11].gameObject);
                }
                else
                {
                    bladesPriceText.text = bladesPrice[currentStateBlades].ToString();
    ...
    public void ShowExplanationPopUp(int num)
    {
        PlayerPrefs.SetInt("ClickUpgrade", num);
        ...
        EventSystem.current.SetSelectedGameObject(null);
        EventSystem.current.SetSelectedGameObject(upgradeBtn.gameObject);//todo
        MenuManager.popupType = 3;
    }

    public void HideExplanationPopUp(int clickedUpgrade)
    {
        SoundManager.Instance.Play_ButtonClick();
        ...
        EventSystem.current.SetSelectedGameObject(shopscroller.GetComponent<ShopBtnManager>().intensifyButtons[clickedUpgrade].gameObject);

        MenuManager.popupType = 2;
    }
    ...
    public void SetClickedUpgrade(int number)
    {
        ...
        {
            case 1:
                UpgradeTitleText.text = "护甲";
                UpgradeDescriptionText.text = "飞机机体保护。\n\n升级增加耐力(抵抗攻击)。";
                ...
                break;
            case 2:
                UpgradeTitleText.text = "主武器";
                UpgradeDescriptionText.text = "主武器。\n\n升级增加伤害和射速。";
                ...
                break;
            case 3:
                UpgradeTitleText.text = "机翼炮";
                UpgradeDescriptionText.text = "另外两门前置炮。\n\n升级增加伤害和射速。";
                ...
                break;
            case 4:
                UpgradeTitleText.text = "机身外侧机枪";
                UpgradeDescriptionText.text = "另外两门侧炮。\n\n升级增加伤害和射速。";
                ...
                break;
            case 5:
                UpgradeTitleText.text = "吸铁石";
                UpgradeDescriptionText.text = "<color=#0000ff>收集时自动激活</color>\n\n收集时吸引星星，但持续时间短。\n\n升级延长持续时间。";
            ...
            case 7:
                ...
                break;
            case 8:
                UpgradeTitleText.text = "炸弹";
                UpgradeDescriptionText.text = "<color=#0000ff>手动激活</color>\n\n解锁具有巨大破坏力的炸弹超级武器。\n\n升级增加伤害。";
                ...
                break;
            case 9:
                UpgradeTitleText.text = "特斯拉";
                UpgradeDescriptionText.text = "<color=#0000ff>手动激活</color>\n\n解锁特斯拉超级武器，使其范围内的一切通电。\n\n升级增加伤害。";
            ...
            case 10:
                ...
                break;
            case 11:
                UpgradeTitleText.text = "叶片";
                UpgradeDescriptionText.text = "<color=#0000ff>手动激活</color>\n\n解锁刀刃超级武器，在飞机周围旋转并提供额外的伤害。\n\n升级增加伤害。";
    ...
    public void BuyFromInfoScreen()
    {
        ...
        else
        {
            ...
            HideExplanationPopUp(clickedUpgrade);
        }
